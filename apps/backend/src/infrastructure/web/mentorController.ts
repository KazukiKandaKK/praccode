...
export function mentorController(fastify: FastifyInstance, deps: MentorDeps) {
  fastify.post('/mentor/learning-plan', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.get('/mentor/assessment', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.get('/mentor/workflow', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.post('/mentor/workflow', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.post('/mentor/feedback', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.get('/mentor/sprint/current', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.get('/mentor/summary', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.get('/mentor/feedback/history', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const query = z
        .object({
          userId: z.string().uuid(),
